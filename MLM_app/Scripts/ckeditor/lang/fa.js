...
CKEDITOR.lang['fa'] =
{
	 ...
	 */
	editorTitle : 'ویرایشگر Content غنی, %1',
	editorHelp : 'کلید Alt+0 را برای راهنمایی بفشارید',

	// ARIA descriptions.
	toolbars	: 'نوار ابزار',
	editor		: 'ویرایشگر Content غنی',
	...
	pagebreak		: 'گنجاندن شکستگی end  برگه',
	...
	common :
	{
		...
		confirmNewPage	: 'هر تغییر Create شدهی ذخیره نشده از بین خواهد رفت. آیا اطمینان دارید که قصد بارگیری صفحه جدیدی را دارید؟',
	...
	findAndReplace :
	{
		title				: 'Search و جایگزینی',
		find				: 'Search',
		replace				: 'جایگزینی',
		findWhat			: 'چه چیز را مییابید:',
		replaceWith			: 'جایگزینی با:',
		notFoundMsg			: 'Content موردنظر یافت نشد.',
		findOptions			: 'گزینههای Search',
	...
	table :
	{
		...
		{
			menu			: 'سلول',
			insertBefore	: 'add  سلول قبل از',
			insertAfter		: 'add  سلول بعد از',
			deleteCell		: 'Delete سلولها',
			merge			: 'ادغام سلولها',
		...
		{
			menu			: 'سطر',
			insertBefore	: 'add  سطر قبل از',
			insertAfter		: 'add  سطر بعد از',
			deleteRow		: 'Delete سطرها'
		},

		column :
		{
			menu			: 'ستون',
			insertBefore	: 'add  ستون قبل از',
			insertAfter		: 'add  ستون بعد از',
			deleteColumn	: 'Delete ستونها'
		}
	},
	...
	clipboard :
	{
		...
		pasteMsg	: 'لطفا Content را با کلیدهای (<STRONG>Ctrl/Cmd+V</STRONG>) در این جعبهٴ متنی بچسبانید و <STRONG>پذیرش</STRONG> را بزنید.',
	...
	pasteText :
	{
		button	: 'چسباندن به عنوان Content ِساده',
		title	: 'چسباندن به عنوان Content ِساده'
	},
	...
	div :
	{
		title				: 'Create یک محل DIV',
		toolbar				: 'Create یک محل DIV',
	...
	bidi :
	{
		ltr : 'نوشتار Content از چپ به راست',
		rtl : 'نوشتار Content از راست به چپ'
	},
	...
	docprops :
	{
		...
		previewHtml : '<p>این یک <strong>Content نمونه</strong> است. شما در حال استفاده از <a href="javascript:void(0)">CKEditor</a> هستید.</p>'
	}
};
