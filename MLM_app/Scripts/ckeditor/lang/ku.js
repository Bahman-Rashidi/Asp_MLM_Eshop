...
CKEDITOR.lang['ku'] =
{
	...
	table :
	{
		...
		invalidCellSpacing	: 'بۆشایی Home‌ ده‌بێت ژماره‌کی درووست بێت.',
		invalidCellPadding	: 'ناوپۆشی Home‌ ده‌بێت ژماره‌کی درووست بێت.',

		cell :
		{
			menu			: 'Home',
			insertBefore	: 'دانانی Home‌ له‌پێش',
			insertAfter		: 'دانانی Home له‌پاش',
			deleteCell		: 'سڕینه‌وه‌ی Home',
			merge			: 'تێکه‌ڵکردنی Home',
			mergeRight		: 'تێکه‌ڵکردنی له‌گه‌ڵ ڕاست',
			mergeDown		: 'تێکه‌ڵکردنی له‌گه‌ڵ خواره‌وه',
			splitHorizontal	: 'دابه‌شکردنی Home‌ی ئاسۆیی',
			splitVertical	: 'دابه‌شکردنی Home‌ی ئه‌ستونی',
			title			: 'خاسیه‌تی Home',
			cellType		: 'جۆری Home',
			...
			yes				: 'به‌ڵێ',
			no				: 'نه‌خێر',
			invalidWidth	: 'پانی Home‌ ده‌بێت به‌ته‌واوی ژماره‌ بێت.',
			invalidHeight	: 'درێژی Home‌ به‌ته‌واوی ده‌بێت ژماره‌ بێت.',
	...
	select :
	{
		title		: 'هه‌ڵبژارده‌ی خاسیه‌تی Home',
		selectInfo	: 'زانیاری',
	...
	hidden :
	{
		title	: 'خاسیه‌تی Home‌ی شاردراوه',
		name	: 'ناو',
		value	: 'نرخ'
	},
	...
	spellCheck :
	{
		...
		errorLoading	: 'هه‌ڵه‌ له‌هێنانی داخوازینامه‌ی Home‌خۆێی ڕاژه: %s.',
